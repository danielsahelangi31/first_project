...
export const csrf: ShieldConfig['csrf'] = {
  ...
  */
  exceptRoutes: [
    ...
    '/logout',
    '/api-master/company',
    '/api-master/pelabuhan',
    '/api-master/customer',
    '/api-master/alat-apung',
    '/api-master/alat-bongkar-muat',
    '/api-master/terminal',
    '/api-master/kapal',
    '/api-master/dermaga',
    '/inaportnet/createKapal',
    '/mdm-re3/create-customer',
    '/master-pegawai/insert-pegawai-new',
    '/master-pegawai/insert-pegawai-secondary-assignment',
    '/master-pegawai/insert-pegawai-action',
    '/master-pegawai/insert-pegawai-previous-employment',
    '/master-pegawai/insert-pegawai-family',
    '/master-pegawai/insert-pegawai-education',
    '/master-pegawai/insert-pegawai-discipline',
    '/master-pegawai/insert-pegawai-addresses',
    '/master-pegawai/insert-struktur-organisasi-new',
    '/master-pegawai/insert-perubahan-organisasi-new',
    '/master-pegawai/insert-pelaksana-harian',
    '/master-pegawai/insert-disability',
    '/master-pegawai/insert-cause-of-death',
